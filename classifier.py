# Adpated from https://github.com/Lornatang/ResNet-PyTorch/blob/main/model.py
...
class _BasicBlock(nn.Module):
    ...
    def __init__(
        ...
        self.conv1 = nn.Conv2d(
            in_channels, out_channels, (3, 3), (stride, stride), (1, 1), bias=False
        )
        self.bn1 = nn.BatchNorm2d(out_channels)
        self.relu = nn.ReLU(True)
        self.conv2 = nn.Conv2d(
            out_channels, out_channels, (3, 3), (1, 1), (1, 1), bias=False
        )
...
class _Bottleneck(nn.Module):
    ...
    def __init__(
        ...
        self.conv1 = nn.Conv2d(
            in_channels, channels, (1, 1), (1, 1), (0, 0), bias=False
        )
        ...
        self.conv3 = nn.Conv2d(
            channels,
            int(out_channels * self.expansion),
            (1, 1),
            (1, 1),
            (0, 0),
            bias=False,
